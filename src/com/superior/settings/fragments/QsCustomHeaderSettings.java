...
public class QsCustomHeaderSettings extends SettingsPreferenceFragment implements
    ...
    private boolean isBrowseHeaderAvailable() {
        ...
        browse.setClassName("org.superior.superiorstyle", "org.superior.superiorstyle.PickHeaderActivity");
    ...
    private void getAvailableHeaderPacks(List<String> entries, List<String> values) {
        ...
        i.setAction("org.superior.DaylightHeaderPack");
        ...
        i.setAction("org.superior.DaylightHeaderPack1");
        for (ResolveInfo r : packageManager.queryIntentActivities(i, 0)) {
            String packageName = r.activityInfo.packageName;
            String label = r.activityInfo.loadLabel(getActivity().getPackageManager()).toString();
